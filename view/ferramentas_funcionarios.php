...
<?php
  ...
  $result1 = $sql->select('
    ...
    WHERE
      ...
      and ( actar.tb_questions_ferramentas_answers.idFerramenta   = ' . $idFerrFunc[0] . ' )
      and ( actar.tb_questions_ferramentas_answers.idFuncionario  = ' . $idFerrFunc[1] . ' )
...
<section>
  <div id="corpo">
    <h1>Análise das Questões Individuais de
      <br>
      <?php echo $idFerrFunc[4] ?>
      <br>
      <?php echo $idFerrFunc[5] ?>
      <br>
      <br>
    </h1>
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="panel-espaco-interno">
          ...
          <br>
          <br>
          Para maiores detalhes sobre as respostas individuais de <?php echo $idFerrFunc[4] ?>, verifique os dados abaixo:
          <br>
          <br>
          <ul>
            <li>Total de Questões: <p class = 'text-bold'><?php echo $idFerrFunc[2] ?></p></li>
            <li>Total de Pontos disponíveis pela Tecnologia: <p class = 'text-bold'><?php echo intval($idFerrFunc[2] * 5) ?></p></li>
            <br>
            <li class='text-bold'>Análise Individual para a Área de Tecnologia:</li>
            <ul>
              <li>Total de Pontos: <p class = 'text-bold'><?php echo $idFerrFunc[3] ?></p></li>
              <li>Percentual das Respostas: <p class = 'text-bold'><?php echo number_format((($idFerrFunc[3] / ($idFerrFunc[2] * 5)) * 100), 2, ".", "") ?>%</p></li>
            </ul>
          </ul>
        </div>
      </div>
