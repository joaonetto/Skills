...
<section>
    ...
    <h5>
      ...
      <br>
      <br>
      A lista abaixo contém <?php echo $total_result2 ?> profissionais analisados neste momento. Estes profissionais pertencem ao Pool da Área de Tecnologia e atuam sobre funções diversas, como é o caso de: Pré-Vendas, Delivery e Suporte. Veja a lista abaixo:
    </h5>
    <br>
    <table>
      <tr>
